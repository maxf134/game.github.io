...
gdjs.evtsExt__DragCameraWithPointer__DragCameraWithPointer.idToCallbackMap = new Map();
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(52383124);
}
